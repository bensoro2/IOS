    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-card border-t border-border px-2 pt-2 z-50 safe-bottom">
      <div className="flex items-center justify-around">
        <button
          ...
          className={`flex flex-col items-center gap-0.5 py-1 flex-1 min-w-0 ${isActive("/") ? "text-primary" : "text-muted-foreground"}`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 py-1 flex-1 min-w-0 ${isActive("/reels") ? "text-primary" : "text-muted-foreground"}`}
        >
          <LayoutGrid className="w-5 h-5" />
          <span className="text-[10px] leading-tight truncate">{t("nav.reels")}</span>
        </button>
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 py-1 flex-1 min-w-0 ${isActive("/messages") ? "text-primary" : "text-muted-foreground"}`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 py-1 flex-1 min-w-0 ${isActive("/profile") ? "text-primary" : "text-muted-foreground"}`}
        >
