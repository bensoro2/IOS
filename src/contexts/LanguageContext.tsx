...
const translations: Record<string, Record<string, string>> = {
  ...
  "home.selectActivity": { th: "เลือกกิจกรรม", en: "Select Activity", ja: "アクティビティを選択", zh: "选择活动", ko: "활동 선택", ru: "Выбрать активность" },
  ...
  "home.safetyWarningTitle": { th: "เพื่อความปลอดภัยของคุณ", en: "For your safety", ja: "安全のために", zh: "为了您的安全", ko: "안전을 위해", ru: "Для вашей безопасности" },
  "home.safetyWarningBody": { th: "การนัดพบคนแปลกหน้ามีความเสี่ยง ห้ามไปคนเดียว ยามวิกาล หรือสถานที่เปลี่ยวโดยเด็ดขาด ควรนัดพบในที่สาธารณะที่มีคนพลุกพล่านเสมอ", en: "Meeting strangers can be risky. Never go alone, at night, or to isolated places — always meet in busy public areas.", ja: "知らない人と会うのはリスクがあります。一人で、深夜に、人気のない場所へは絶対に行かないでください。必ず人通りの多い公共の場所で会いましょう。", zh: "与陌生人见面存在风险。切勿独自一人、深夜或前往偏僻场所，请务必在人多的公共场所见面。", ko: "낯선 사람과의 만남은 위험할 수 있습니다. 혼자, 야간에, 인적이 드문 곳에는 절대 가지 마세요. 항상 사람이 많은 공공장소에서 만나세요.", ru: "Встречи с незнакомцами могут быть рискованными. Никогда не ходите одни, ночью или в безлюдные места — встречайтесь только в людных общественных местах." },
  ...
  // Search
  "search.usersPlaceholder": { th: "ค้นหาผู้ใช้...", en: "Search users...", ja: "ユーザーを検索...", zh: "搜索用户...", ko: "사용자 검색...", ru: "Поиск пользователей..." },
  "search.noUsersFound": { th: "ไม่พบผู้ใช้", en: "No users found", ja: "ユーザーが見つかりません", zh: "未找到用户", ko: "사용자를 찾을 수 없습니다", ru: "Пользователи не найдены" },
  ...
  "shop.searchCategoryInput": { th: "ค้นหาหมวดหมู่...", en: "Search category...", ja: "カテゴリ検索...", zh: "搜索分类...", ko: "카테고리 검색...", ru: "Поиск..." },
   ...
   "common.close": { th: "ปิด", en: "Close", ja: "閉じる", zh: "关闭", ko: "닫기", ru: "Закрыть" },
  ...
  "upload.aiModerationNotice": { th: "รูปภาพนี้จะถูกตรวจสอบโดยระบบ AI อัตโนมัติก่อนเผยแพร่ ตามนโยบายความเป็นส่วนตัว", en: "This image will be automatically screened by AI before publishing, per our Privacy Policy.", ja: "この画像は公開前にAIによって自動的に審査されます（プライバシーポリシーに基づく）。", zh: "此图片在发布前将由 AI 自动审核，依据我们的隐私政策。", ko: "이 이미지는 게시 전 개인정보처리방침에 따라 AI로 자동 검토됩니다.", ru: "Это изображение будет автоматически проверено ИИ перед публикацией согласно нашей Политике конфиденциальности." },
  "upload.aiModerationNoticeVideo": { th: "วิดีโอนี้จะถูกตรวจสอบโดยระบบ AI อัตโนมัติก่อนเผยแพร่ ตามนโยบายความเป็นส่วนตัว", en: "This video will be automatically screened by AI before publishing, per our Privacy Policy.", ja: "この動画は公開前にAIによって自動的に審査されます（プライバシーポリシーに基づく）。", zh: "此视频在发布前将由 AI 自动审核，依据我们的隐私政策。", ko: "이 동영상은 게시 전 개인정보처리방침에 따라 AI로 자동 검토됩니다.", ru: "Это видео будет автоматически проверено ИИ перед публикацией согласно нашей Политике конфиденциальности." },
  ...
  "sub.checkoutError": { th: "เกิดข้อผิดพลาดในการสร้าง checkout", en: "Error creating checkout", ja: "チェックアウト作成エラー", zh: "创建结账时出错", ko: "결제 생성 오류", ru: "Ошибка создания оплаты" },
   ...
   "sub.payWith": { th: "ชำระด้วย", en: "Pay with", ja: "支払方法", zh: "支付方式", ko: "결제 방법", ru: "Оплатить" },
   "sub.levelCoin": { th: "Level Coin", en: "Level Coin", ja: "Level Coin", zh: "Level Coin", ko: "Level Coin", ru: "Level Coin" },
   "sub.starCoin": { th: "Star Coin", en: "Star Coin", ja: "Star Coin", zh: "Star Coin", ko: "Star Coin", ru: "Star Coin" },
   "sub.yourBalance": { th: "คงเหลือ", en: "Balance", ja: "残高", zh: "余额", ko: "잔액", ru: "Баланс" },
   "sub.insufficient": { th: "เหรียญไม่พอ", en: "Insufficient balance", ja: "残高不足", zh: "余额不足", ko: "잔액 부족", ru: "Недостаточно" },
   "sub.buyLevelCoin": { th: "ซื้อ Level Coin เพิ่ม", en: "Buy more Level Coin", ja: "Level Coin を購入", zh: "购买 Level Coin", ko: "Level Coin 구매", ru: "Купить Level Coin" },
   "sub.earnStarCoin": { th: "วิธีเก็บ Star Coin", en: "How to earn Star Coin", ja: "Star Coin の獲得方法", zh: "如何获得 Star Coin", ko: "Star Coin 얻는 방법", ru: "Как получить Star Coin" },
   "sub.redeem": { th: "แลกแพ็กเกจ", en: "Redeem plan", ja: "プラン交換", zh: "兑换套餐", ko: "플랜 교환", ru: "Обменять" },
   "sub.redeemSuccess": { th: "สมัครสมาชิกสำเร็จ!", en: "Subscription activated!", ja: "登録完了!", zh: "订阅成功!", ko: "구독 완료!", ru: "Подписка активирована!" },
   "sub.redeemError": { th: "แลกไม่สำเร็จ", en: "Redeem failed", ja: "交換失敗", zh: "兑换失败", ko: "교환 실패", ru: "Не удалось обменять" },
   "sub.confirmRedeem": { th: "ยืนยันการแลก", en: "Confirm redemption", ja: "交換を確認", zh: "确认兑换", ko: "교환 확인", ru: "Подтвердить обмен" },
   "subHistory.title": { th: "ประวัติการสมัคร", en: "Subscription history", ja: "登録履歴", zh: "订阅记录", ko: "구독 내역", ru: "История подписок" },
   "subHistory.empty": { th: "ยังไม่มีประวัติการสมัคร", en: "No subscription history yet", ja: "履歴はまだありません", zh: "暂无订阅记录", ko: "구독 내역이 없습니다", ru: "История пуста" },
   // Star Coin page
   "star.title": { th: "Star Coin", en: "Star Coin", ja: "Star Coin", zh: "Star Coin", ko: "Star Coin", ru: "Star Coin" },
   "star.balance": { th: "Star Coin ของคุณ", en: "Your Star Coins", ja: "あなたの Star Coin", zh: "您的 Star Coin", ko: "내 Star Coin", ru: "Ваши Star Coin" },
   "star.earn.title": { th: "วิธีเก็บ Star Coin", en: "How to earn Star Coin", ja: "獲得方法", zh: "如何获得", ko: "얻는 방법", ru: "Как получить" },
   "star.earn.checkin": { th: "เช็คอินกิจกรรมปกติ ได้ 1 ⭐ ต่อครั้ง", en: "Check-in on an activity to earn 1 ⭐ each", ja: "アクティビティにチェックインで 1 ⭐", zh: "签到活动获得 1 ⭐", ko: "활동 체크인마다 1 ⭐", ru: "Отметка активности — 1 ⭐" },
   "star.earn.fastCheckin": { th: "Fast Check-in (สำหรับสมาชิก) ได้ 1 ⭐ ต่อครั้ง", en: "Fast Check-in (members) — 1 ⭐ each", ja: "ファストチェックイン (会員) 1 ⭐", zh: "快速签到 (会员) 1 ⭐", ko: "빠른 체크인 (회원) 1 ⭐", ru: "Быстрая отметка (участники) — 1 ⭐" },
   "star.earn.friendCode": { th: "ให้เพื่อนใส่โค้ดผู้ใช้ของคุณ ได้ 1 ⭐ ต่อคน", en: "Friend redeems your user code — 1 ⭐ each", ja: "友達があなたのコード使用で 1 ⭐", zh: "朋友使用您的用户码 1 ⭐", ko: "친구가 사용자 코드 사용 시 1 ⭐", ru: "Друг ввёл ваш код — 1 ⭐" },
   "star.earn.note": { th: "เก็บได้ประมาณ 5 ⭐/วัน", en: "About 5 ⭐ per day is realistic", ja: "1日約 5 ⭐ が現実的", zh: "每天约可获得 5 ⭐", ko: "하루 약 5 ⭐ 획득 가능", ru: "Около 5 ⭐ в день" },
   "star.redeem.title": { th: "ราคาแลกแพ็กเกจ", en: "Redeem prices", ja: "交換価格", zh: "兑换价格", ko: "교환 가격", ru: "Цены обмена" },
   "star.redeem.cta.title": { th: "แลกแพ็กเกจสมาชิก", en: "Redeem a membership plan", ja: "会員プランを交換", zh: "兑换会员套餐", ko: "멤버십 플랜 교환", ru: "Обменять на подписку" },
   "star.redeem.cta.desc": { th: "ใช้ Level Coin หรือ Star Coin แลก Pro / Gold ได้เลย", en: "Use Level Coin or Star Coin to redeem Pro / Gold", ja: "Level Coin か Star Coin で Pro / Gold と交換", zh: "使用 Level Coin 或 Star Coin 兑换 Pro / Gold", ko: "Level Coin 또는 Star Coin 으로 Pro / Gold 교환", ru: "Обменяйте Level Coin или Star Coin на Pro / Gold" },
   "star.crossLevel": { th: "ไปหน้า Level Coin", en: "Go to Level Coin", ja: "Level Coin ページ", zh: "前往 Level Coin", ko: "Level Coin 페이지", ru: "К Level Coin" },
   ...
   "auth.acceptTerms": { th: "ฉันได้อ่านและยอมรับ", en: "I have read and accept the", ja: "私は読み、同意します", zh: "我已阅读并接受", ko: "읽고 동의합니다", ru: "Я прочитал(а) и принимаю" },
   "auth.acceptTermsAnd": { th: "และ", en: "and", ja: "および", zh: "和", ko: "및", ru: "и" },
   "auth.mustAcceptTerms": { th: "กรุณายอมรับเงื่อนไขการใช้บริการและนโยบายความเป็นส่วนตัวก่อนสมัครสมาชิก", en: "Please accept the Terms of Service and Privacy Policy before registering", ja: "登録前に利用規約とプライバシーポリシーに同意してください", zh: "请在注册前接受服务条款和隐私政策", ko: "가입 전에 이용약관 및 개인정보 처리방침에 동의하세요", ru: "Пожалуйста, примите Условия и Политику конфиденциальности перед регистрацией" },
   ...
   "notif.duoRequest": { th: "ขอเป็น Duo กับคุณ", en: "wants to be your Duo", ja: "があなたとDuoになりたがっています", zh: "想与你成为 Duo", ko: "님이 Duo 요청을 보냈습니다", ru: "хочет стать вашим Duo" },
   "notif.duoAccepted": { th: "ตอบรับคำขอ Duo ของคุณแล้ว", en: "accepted your Duo request", ja: "があなたのDuoリクエストを承認しました", zh: "接受了你的 Duo 请求", ko: "님이 Duo 요청을 수락했습니다", ru: "принял ваш Duo-запрос" },
   "notif.duoRejected": { th: "ปฏิเสธคำขอ Duo ของคุณ", en: "declined your Duo request", ja: "があなたのDuoリクエストを拒否しました", zh: "拒绝了你的 Duo 请求", ko: "님이 Duo 요청을 거절했습니다", ru: "отклонил ваш Duo-запрос" },
   "notif.duoCancelled": { th: "ได้ยกเลิกการเป็น Duo กับคุณ", en: "ended the Duo with you", ja: "がDuoを解除しました", zh: "结束了与你的 Duo", ko: "님이 Duo를 해제했습니다", ru: "завершил Duo с вами" },
   "duo.request": { th: "ขอเป็น Duo", en: "Duo", ja: "Duo", zh: "Duo", ko: "Duo", ru: "Duo" },
   "duo.paired": { th: "Duo", en: "Duo", ja: "Duo", zh: "Duo", ko: "Duo", ru: "Duo" },
   "duo.pending": { th: "รอตอบรับ", en: "Pending", ja: "保留中", zh: "等待中", ko: "대기 중", ru: "Ожидание" },
   "duo.respond": { th: "ตอบคำขอ", en: "Respond", ja: "応答", zh: "回应", ko: "응답", ru: "Ответить" },
   "duo.cooldown": { th: "รอ Duo", en: "Cooldown", ja: "クールダウン", zh: "冷却中", ko: "쿨다운", ru: "Ожидание" },
   "duo.accept": { th: "ยอมรับ", en: "Accept", ja: "承認", zh: "接受", ko: "수락", ru: "Принять" },
   "duo.reject": { th: "ปฏิเสธ", en: "Decline", ja: "拒否", zh: "拒绝", ko: "거절", ru: "Отклонить" },
   "duo.endDuo": { th: "ยกเลิก Duo", en: "End Duo", ja: "Duoを解除", zh: "结束 Duo", ko: "Duo 해제", ru: "Завершить Duo" },
   "duo.confirmEndTitle": { th: "ยกเลิกการเป็น Duo?", en: "End this Duo?", ja: "Duoを解除しますか？", zh: "结束此 Duo？", ko: "Duo를 해제하시겠습니까?", ru: "Завершить этот Duo?" },
   "duo.confirmEndDesc": { th: "หลังจากยกเลิกแล้ว ทั้งสองฝ่ายต้องรอ 3 วันจึงจะสามารถเข้าร่วม Duo ใหม่ได้", en: "After ending, both users must wait 3 days before joining a new Duo.", ja: "解除後、両者とも新しいDuoに参加するには3日待つ必要があります。", zh: "结束后，双方必须等待 3 天才能加入新的 Duo。", ko: "해제 후 양쪽 모두 3일간 새 Duo에 참여할 수 없습니다.", ru: "После завершения оба пользователя должны подождать 3 дня." },
   "duo.requestSent": { th: "ส่งคำขอ Duo แล้ว", en: "Duo request sent", ja: "Duoリクエストを送信しました", zh: "已发送 Duo 请求", ko: "Duo 요청 전송됨", ru: "Duo-запрос отправлен" },
   "duo.requestCancelled": { th: "ยกเลิกคำขอแล้ว", en: "Request cancelled", ja: "リクエストをキャンセルしました", zh: "已取消请求", ko: "요청 취소됨", ru: "Запрос отменён" },
   "duo.duoEnded": { th: "ยกเลิก Duo แล้ว", en: "Duo ended", ja: "Duoを解除しました", zh: "Duo 已结束", ko: "Duo 해제됨", ru: "Duo завершён" },
   "duo.acceptedToast": { th: "ยอมรับ Duo แล้ว 🎉", en: "Duo accepted 🎉", ja: "Duoを承認しました 🎉", zh: "已接受 Duo 🎉", ko: "Duo 수락됨 🎉", ru: "Duo принят 🎉" },
   "duo.rejectedToast": { th: "ปฏิเสธคำขอแล้ว", en: "Request declined", ja: "リクエストを拒否しました", zh: "已拒绝请求", ko: "요청 거절됨", ru: "Запрос отклонён" },
   "duo.selfInDuo": { th: "คุณมี Duo อยู่แล้ว", en: "You already have a Duo", ja: "既にDuoがあります", zh: "你已经有 Duo 了", ko: "이미 Duo가 있습니다", ru: "У вас уже есть Duo" },
   "duo.otherInDuo": { th: "ผู้ใช้นี้มี Duo อยู่แล้ว", en: "This user already has a Duo", ja: "このユーザーは既にDuoがあります", zh: "此用户已有 Duo", ko: "이 사용자는 이미 Duo가 있습니다", ru: "У этого пользователя уже есть Duo" },
   "duo.pendingExists": { th: "มีคำขอค้างอยู่แล้ว", en: "A request is already pending", ja: "既にリクエストが保留中です", zh: "已有待处理请求", ko: "이미 대기 중인 요청이 있습니다", ru: "Запрос уже отправлен" },
   "duo.cooldownActive": { th: "ยังอยู่ในช่วงรอ 3 วัน", en: "Still in 3-day cooldown", ja: "3日間のクールダウン中です", zh: "仍在 3 天冷却期内", ko: "3일 쿨다운 중입니다", ru: "3-дневный период ожидания" },
   "duo.cooldownWait": { th: "รออีก {days} วันจึงจะสามารถขอ Duo ได้", en: "Wait {days} more day(s) to request Duo", ja: "Duoをリクエストするにはあと{days}日待ってください", zh: "还需等待 {days} 天才能请求 Duo", ko: "Duo 요청까지 {days}일 남았습니다", ru: "Подождите ещё {days} дн." },
   "duo.checkNotifications": { th: "ผู้ใช้นี้ส่งคำขอ Duo มาแล้ว โปรดตรวจสอบการแจ้งเตือน", en: "This user sent you a Duo request. Check notifications.", ja: "このユーザーからDuoリクエストがあります。通知を確認してください。", zh: "此用户已发送 Duo 请求，请查看通知。", ko: "이 사용자가 Duo 요청을 보냈습니다. 알림을 확인하세요.", ru: "Этот пользователь отправил Duo-запрос. Проверьте уведомления." },
   "duo.requestGone": { th: "คำขอนี้ไม่มีอยู่แล้ว", en: "This request no longer exists", ja: "このリクエストは存在しません", zh: "此请求已不存在", ko: "이 요청은 더 이상 존재하지 않습니다", ru: "Этот запрос больше не существует" },
   "duo.noPartnerHint": { th: "คุณยังไม่มี Duo กดไอคอน Duo ในหน้าโปรไฟล์ของคนอื่นเพื่อส่งคำขอ", en: "You don't have a Duo yet. Tap the Duo icon on another user's profile to send a request.", ja: "まだDuoがありません。他ユーザーのプロフィールでDuoアイコンをタップしてリクエストしてください。", zh: "你还没有 Duo。点击其他用户资料上的 Duo 图标发送请求。", ko: "아직 Duo가 없습니다. 다른 사용자 프로필의 Duo 아이콘을 눌러 요청하세요.", ru: "У вас пока нет Duo. Нажмите иконку Duo в чужом профиле, чтобы отправить запрос." },
   "duo.currentDuo": { th: "Duo ปัจจุบัน", en: "Current Duo", ja: "現在のDuo", zh: "当前 Duo", ko: "현재 Duo", ru: "Текущий Duo" },
   "duo.viewProfile": { th: "ดูโปรไฟล์", en: "View profile", ja: "プロフィールを見る", zh: "查看资料", ko: "프로필 보기", ru: "Открыть профиль" },
   "duo.closeDialog": { th: "ปิด", en: "Close", ja: "閉じる", zh: "关闭", ko: "닫기", ru: "Закрыть" },
